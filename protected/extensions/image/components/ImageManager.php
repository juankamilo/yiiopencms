...
class ImageManager extends CApplicationComponent
{
	 ...
	 */
	public function save($file, $owner, $name = null, $path = null)
	{
		...
		if ($owner instanceof CActiveRecord)
		{
			...
			{
				$image = new Image();
				$image->owner = get_class($owner);
				$image->ownerId = $owner->getPrimaryKey();
			...
			throw new CException(__CLASS__.': Failed to save image! Owner is not an instance of CActiveRecord.');
	}
